...
class ListGoatSell extends StatefulWidget {
  @override
  State<ListGoatSell> createState() => _ListGoatSellState();
}

class _ListGoatSellState extends State<ListGoatSell> {
  // const ListGoatSell({Key? key}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder(
                    future: kandang_c.listHewan("", "1", "", "1", "", "", 1),
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                menuModal(id, harga_jual, diskon);
              },
  ...
  void confirm_batal_jual(String id) {
    // warehouseController w_controller = Get.find();
    final kandang_c = Get.put(KambingController());

    Get.defaultDialog(
        title: 'Batal Jual Ternak',
        titleStyle: GoogleFonts.montserrat(
            fontSize: 14,
            color: Color(0xff333333),
            fontWeight: FontWeight.bold),
        content: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                  "Apakah Anda Yakin Akan Membatalkan Penjualan kambing?",
                  style: GoogleFonts.montserrat(
                      fontSize: 12,
                      color: Color(0xff333333),
                      fontWeight: FontWeight.normal)),
  ...
  void confirm_jual(String id, String harga, int diskon) {
    // warehouseController w_controller = Get.find();
    final kandang_c = Get.put(KambingController());
    kandang_c.jual_kambing_u.text =
        NumberFormat.decimalPattern().format(int.parse(harga));

    kandang_c.diskon_kambing_u.text = diskon.toString();

    Get.defaultDialog(
        title: 'Ubah Harga Kambing',
        titleStyle: GoogleFonts.montserrat(
            fontSize: 14,
            color: Color(0xff333333),
            fontWeight: FontWeight.bold),
        content: Column(
          ...
          children: [
            ...
            TextFormField(
                ...
                controller: kandang_c.jual_kambing_u,
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                  focusedBorder: OutlineInputBorder(
                    borderSide:
            ...
            TextFormField(
                ...
                keyboardType: TextInputType.number,
                controller: kandang_c.diskon_kambing_u,
                decoration: InputDecoration(
                  focusedBorder: OutlineInputBorder(
                    borderSide:
                        const BorderSide(color: Color(0XFF71A841), width: 2.0),
  ...
  void menuModal(String id, String harga_jual, int diskon) {
    Get.defaultDialog(
        title: 'Pilih Menu',
        titleStyle: GoogleFonts.montserrat(
            fontSize: 14,
        ...
        content: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.close(0);
                confirm_jual(id, harga_jual, diskon);
              },
              child: Container(
                height: 40,
                width: double.infinity,
