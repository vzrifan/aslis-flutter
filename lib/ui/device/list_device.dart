...
class _DevicePageState extends State<DevicePage> {
  ...
  final device_c = Get.put(DeviceController());
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          return Obx(() => device_c.list_device.length == 0
                              ? Column(
                                  children: [
                                    SizedBox(
                                      height: 80,
                              ...
                              : Obx(() => ListView.builder(
                                    itemCount: device_c.list_device.length,
                                    physics: NeverScrollableScrollPhysics(),
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      return BoxList(
                                          device_c.list_device[index]
                                              ['device_id'],
                                          device_c.list_device[index]
                                              ['device_name'],
                                          device_c.list_device[index]['id'],
                                          device_c.list_device[index]
                                              ['shed_name'],
                                          context);
                                    },
    ...
    Get.defaultDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Center(
              child: Text("Apakah anda yakin akan hapus device?",
